            ...
            <aside class="col-md-3 px-1 px-md-0 bg-side h-100" id="sidebar" style="/*overflow-x:hidden;*/">
                ...
                <div class="container-fluid px-0 text-center">
                    ...
                    <a href="{{url('/administration')}}">
                        <h2 class="bg-sombre">Transport</h2>
                    </a>
                        ...
                        <ul class="navbar-nav w-100 ml-5" id="sidebar-nav">
                            ...
                            <li class="nav-item">
                                <a href="{{url('/cars')}}" class="nav-link ">
                                    <span>Cars</span>
                                    <span class="badge bg-normal">{{ App\Car::count()}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/drivers')}}" class="nav-link ">
                                    <span>Chauffeurs</span>
                                    <span class="badge bg-normal">{{ App\Driver::count()}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/stations')}}" class="nav-link ">
                                    <span>Gares</span>
                                    <span class="badge bg-normal">{{ App\Station::count()}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('/cities')}}" class="nav-link ">
                                    <span>Villes</span>
                                    <span class="badge bg-normal">{{ App\City::count()}}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <!-- <li class="nav-item">
                                <a href="{{--url('/luggages')--}}" class="nav-link "><span>Baggages</span>
                                    <span class="badge bg-normal">{{-- App\Luggage::count()--}}</span>
                                </a>
                            </li> -->
                        </ul>
                    </div>
